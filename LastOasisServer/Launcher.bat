...
:Config_SteamCMD
set appid=920720
set login=dkdue79 Chemalagunamena25041979
...
set command_line2=-log -force_steamclient_link -messaging -NoLiveServer -EnableCheats -backendapiurloverride="backend.last-oasis.com" -identifier=Ciudad -port=5560 -QueryPort=27020 -slots=25 -CustomerKey=qNw0DZgGBar3JGBy -ProviderKey=eRTbfOGgGbX2MKZe -OverrideConnectionAddress=%NetworkIP%
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:IP
::IPv4 IP Localhost
...
start 	  %install_server%\%server_exe% %command_line%
start /wait %install_server%\%server_exe% %command_line2%
